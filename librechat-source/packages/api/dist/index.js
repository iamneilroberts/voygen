        ...
        for (const roleName of [librechatDataProvider.SystemRoles.USER, librechatDataProvider.SystemRoles.ADMIN]) {
            ...
            const allPermissions = {
                ...
                [librechatDataProvider.PermissionTypes.MEMORIES]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.memories, (_f = defaultPerms[librechatDataProvider.PermissionTypes.MEMORIES]) === null || _f === void 0 ? void 0 : _f[librechatDataProvider.Permissions.USE], defaults.memories),
                    [librechatDataProvider.Permissions.OPT_OUT]: isPersonalizationEnabled,
                },
                [librechatDataProvider.PermissionTypes.MULTI_CONVO]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.multiConvo, (_g = defaultPerms[librechatDataProvider.PermissionTypes.MULTI_CONVO]) === null || _g === void 0 ? void 0 : _g[librechatDataProvider.Permissions.USE], defaults.multiConvo),
                },
                [librechatDataProvider.PermissionTypes.AGENTS]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.agents, (_h = defaultPerms[librechatDataProvider.PermissionTypes.AGENTS]) === null || _h === void 0 ? void 0 : _h[librechatDataProvider.Permissions.USE], defaults.agents),
                },
                [librechatDataProvider.PermissionTypes.TEMPORARY_CHAT]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.temporaryChat, (_j = defaultPerms[librechatDataProvider.PermissionTypes.TEMPORARY_CHAT]) === null || _j === void 0 ? void 0 : _j[librechatDataProvider.Permissions.USE], defaults.temporaryChat),
                },
                [librechatDataProvider.PermissionTypes.RUN_CODE]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.runCode, (_k = defaultPerms[librechatDataProvider.PermissionTypes.RUN_CODE]) === null || _k === void 0 ? void 0 : _k[librechatDataProvider.Permissions.USE], defaults.runCode),
                },
                [librechatDataProvider.PermissionTypes.WEB_SEARCH]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.webSearch, (_l = defaultPerms[librechatDataProvider.PermissionTypes.WEB_SEARCH]) === null || _l === void 0 ? void 0 : _l[librechatDataProvider.Permissions.USE], defaults.webSearch),
                },
                [librechatDataProvider.PermissionTypes.PEOPLE_PICKER]: {
                    [librechatDataProvider.Permissions.VIEW_USERS]: getPermissionValue((_m = loadedInterface.peoplePicker) === null || _m === void 0 ? void 0 : _m.users, (_o = defaultPerms[librechatDataProvider.PermissionTypes.PEOPLE_PICKER]) === null || _o === void 0 ? void 0 : _o[librechatDataProvider.Permissions.VIEW_USERS], (_p = defaults.peoplePicker) === null || _p === void 0 ? void 0 : _p.users),
                    [librechatDataProvider.Permissions.VIEW_GROUPS]: getPermissionValue((_q = loadedInterface.peoplePicker) === null || _q === void 0 ? void 0 : _q.groups, (_r = defaultPerms[librechatDataProvider.PermissionTypes.PEOPLE_PICKER]) === null || _r === void 0 ? void 0 : _r[librechatDataProvider.Permissions.VIEW_GROUPS], (_s = defaults.peoplePicker) === null || _s === void 0 ? void 0 : _s.groups),
                    [librechatDataProvider.Permissions.VIEW_ROLES]: getPermissionValue((_t = loadedInterface.peoplePicker) === null || _t === void 0 ? void 0 : _t.roles, (_u = defaultPerms[librechatDataProvider.PermissionTypes.PEOPLE_PICKER]) === null || _u === void 0 ? void 0 : _u[librechatDataProvider.Permissions.VIEW_ROLES], (_v = defaults.peoplePicker) === null || _v === void 0 ? void 0 : _v.roles),
                },
                [librechatDataProvider.PermissionTypes.MARKETPLACE]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue((_w = loadedInterface.marketplace) === null || _w === void 0 ? void 0 : _w.use, (_x = defaultPerms[librechatDataProvider.PermissionTypes.MARKETPLACE]) === null || _x === void 0 ? void 0 : _x[librechatDataProvider.Permissions.USE], (_y = defaults.marketplace) === null || _y === void 0 ? void 0 : _y.use),
                },
                [librechatDataProvider.PermissionTypes.FILE_SEARCH]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.fileSearch, (_z = defaultPerms[librechatDataProvider.PermissionTypes.FILE_SEARCH]) === null || _z === void 0 ? void 0 : _z[librechatDataProvider.Permissions.USE], defaults.fileSearch),
                },
                [librechatDataProvider.PermissionTypes.FILE_CITATIONS]: {
                    [librechatDataProvider.Permissions.USE]: getPermissionValue(loadedInterface.fileCitations, (_0 = defaultPerms[librechatDataProvider.PermissionTypes.FILE_CITATIONS]) === null || _0 === void 0 ? void 0 : _0[librechatDataProvider.Permissions.USE], defaults.fileCitations),
                },
            };
...
function findOpenIDUser({ openidId, email, findUser, strategyName = 'openid', }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        dataSchemas.logger.info(`[${strategyName}] user ${user ? 'found' : 'not found'} with openidId: ${openidId}`);
...
function checkAgentPermissionsMigration({ methods, mongoose, AgentModel, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (db) {
                yield ensureCollectionExists(db, 'aclentries');
            }
...
function getOpenAIConfig(apiKey, options = {}, endpoint) {
    var _a;
    const { modelOptions: _modelOptions = {}, reverseProxyUrl, directEndpoint, defaultQuery, headers, proxy, azure, streaming = true, addParams, dropParams, } = options;
...
const initializeOpenAI = ({ req, appConfig, overrideModel, endpointOption, overrideEndpoint, getUserKeyValues, checkUserKeyExpiry, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isAzureOpenAI && azureConfig) {
        ...
        apiKey = (_f = clientOptions.azure) === null || _f === void 0 ? void 0 : _f.azureOpenAIApiKey;
    }
    ...
    const openAIConfig = (_g = appConfig.endpoints) === null || _g === void 0 ? void 0 : _g[librechatDataProvider.EModelEndpoint.openAI];
    const allConfig = (_h = appConfig.endpoints) === null || _h === void 0 ? void 0 : _h.all;
    const azureRate = (modelName === null || modelName === void 0 ? void 0 : modelName.includes('gpt-4')) ? 30 : 17;
    let streamRate;
    if (isAzureOpenAI && azureConfig) {
        streamRate = (_j = azureConfig.streamRate) !== null && _j !== void 0 ? _j : azureRate;
    }
...
function loadAuthConfig(context) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const ocrConfig = (_a = context.appConfig) === null || _a === void 0 ? void 0 : _a.ocr;
...
const uploadMistralOCR = (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const model = getModelConfig((_a = context.appConfig) === null || _a === void 0 ? void 0 : _a.ocr);
...
const uploadAzureMistralOCR = (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const model = getModelConfig((_b = context.appConfig) === null || _b === void 0 ? void 0 : _b.ocr);
...
const uploadGoogleVertexMistralOCR = (context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const model = getModelConfig((_c = context.appConfig) === null || _c === void 0 ? void 0 : _c.ocr);
        const buffer = fs__namespace.readFileSync(context.file.path);
        const base64 = buffer.toString('base64');
...
const oaiToolkit = {
    image_gen_oai: {
        ...
        schema: zod.z.object({
            prompt: zod.z.string().max(32000).describe(getImageGenPromptDescription()),
            background: zod.z
...
`.trim()),
            prompt: zod.z.string().max(32000).describe(getImageEditPromptDescription()),
            /*
              n: z
                .number()
                .int()
...
Example: query="cooking pasta tutorials" maxResults=3`,
        schema: zod.z.object({
            query: zod.z.string().describe('Search query terms'),
            maxResults: zod.z.number().int().min(1).max(50).optional().describe('Number of results (1-50)'),
        }),
    },
    youtube_info: {
        name: 'youtube_info',
...
Example: url="https://youtube.com/watch?v=abc123" or url="abc123"`,
        schema: zod.z.object({
            url: zod.z.string().describe('YouTube video URL or ID'),
        }),
    },
    youtube_comments: {
